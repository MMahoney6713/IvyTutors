...
// const mock = [
//   {
//     title: 'Interested in being a part of Ivy League Tutoring?',
//     subtitle:
//       'Become a student or a tutor to see what\'s happening.',
//     icon: (
//       <svg
//         height={24}
//         width={24}
    ...
    <Box>
      <Box marginBottom={4}>
        <Typography
          ...
          sx={{ fontWeight: 700 }}
        >
          Interested in being a part of Ivy League Tutoring?
        </Typography>
        <Typography
          variant={'h6'}
          component={'p'}
